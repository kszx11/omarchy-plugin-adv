...
Item {
    ...
    function apiKeyOrExplain() {
        if (apiKeyValue.trim().length > 0) return apiKeyValue.trim()
    ...
    function loadApiKey(raw) {
        ...
        try {
            ...
            rememberedKey = typeof parsed.apiKey === "string" ? parsed.apiKey.trim() : ""
        } catch (ignored) {}
        apiKeyLoaded = true
    ...
    function persistCurrentGame() {
        ...
        next[activeKeyFingerprint] = Adventure.serialize(transcriptEntries())
        savedGames = next
        savedGamesFile.setText(JSON.stringify(savedGames, null, 2) + "\n")
    }
    ...
    Process {
        ...
        command: ["install", "-d", "-m", "700", root.privateStateDir]
        onExited: {
            apiKeyFile.reload()
    ...
    FileView {
        id: apiKeyFile
        path: root.apiKeyPath
        watchChanges: false
        atomicWrites: true
        printErrors: false
        onLoaded: root.loadApiKey(text())
        onLoadFailed: root.loadApiKey("")
    }
    FileView {
        id: savedGamesFile
        path: root.savesPath
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Label { text: root.gameState.location; Layout.fillWidth: true; color: Color.foreground; elide: Label.ElideRight }
                    ...
                    Rectangle {
                        ...
                        ScrollView {
                            ...
                            Column {
                                ...
                                Label { text: root.gameState.location; width: parent.width; wrapMode: Text.Wrap; color: Color.foreground; font.pixelSize: 17 }
                                ...
                                Repeater {
                                    ...
                                    delegate: Column {
                                        ...
                                        Label { text: modelData[0]; color: Color.muted; font.bold: true; font.pixelSize: 11 }
                                        Repeater {
                                            model: modelData[1]
                                            delegate: Rectangle {
                                                id: sceneAction
                                ...
                                Repeater { model: Object.keys(root.gameState.stats); delegate: Label { text: modelData + ": " + root.gameState.stats[modelData]; color: Color.foreground } }
                                Label { text: "INVENTORY"; color: Color.muted; font.bold: true; font.pixelSize: 11 }
                                Label { text: root.gameState.inventory.join(", ") || "Empty"; width: parent.width; wrapMode: Text.Wrap; color: Color.foreground }
                            }
                        }
                    }
                    Rectangle {
